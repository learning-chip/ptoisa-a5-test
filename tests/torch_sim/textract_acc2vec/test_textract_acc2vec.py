#!/usr/bin/env python3
"""Self-contained textract_acc2vec smoke test (torch_npu + ctypes)."""
...
from common.acc_golden_smoke import make_nz2nd_3_extract
...
_LIB = ctypes.CDLL(str(Path(__file__).parent / "build" / "libtextract_acc2vec.so"))
bind_launch(_LIB, "pto_launch_nz2nd_3", 5)


def case_nz2nd_3():
    x1, x2, dst_preload, golden = make_nz2nd_3_extract()
