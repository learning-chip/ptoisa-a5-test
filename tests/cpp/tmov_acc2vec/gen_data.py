...
if __name__ == "__main__":
    ...
    case_name_list = [
        ...
        "case_nz2nd_split_1",
        "case_nz2nd_split_2",
        "case_nz2nd_uf_partial",
        "case_nz2nd_uf_final_mode",
        "case_nz2nz_1",
        "case_nz2nz_2",
        "case_nz2nz_3",
        "case_nz2nz_4",
        ...
        "case_nz2dn_4",
        # Quant pre
        "case_nz2nz_fb_quant_1",
        "case_nz2nz_fb_quant_2",
        "case_nz2nz_fb_quant_3",
        "case_nz2nz_fb_quant_4",
        "case_nz2nz_sc_quant_1",
        "case_nz2nz_sc_quant_2",
        "case_nz2nz_sc_quant_3",
        "case_nz2nz_sc_quant_4",
        "case_nz2nd_fb_quant_1",
        "case_nz2nd_fb_quant_2",
        "case_nz2nd_fb_quant_3",
        "case_nz2nd_fb_quant_4",
        "case_nz2nd_fb_quant_5",
        "case_nz2nd_fb_quant_uf_partial",
        "case_nz2nd_fb_quant_uf_final_mode",
        "case_nz2nd_sc_quant_1",
        "case_nz2nd_sc_quant_2",
        "case_nz2nd_sc_quant_3",
        "case_nz2nd_sc_quant_4",
        "case_nz2nd_sc_quant_uf_partial",
        "case_nz2nd_sc_quant_uf_final_mode",
        "case_nz2dn_fb_quant_1",
        "case_nz2dn_fb_quant_2",
        "case_nz2dn_fb_quant_3",
        "case_nz2dn_fb_quant_4",
        "case_nz2dn_sc_quant_1",
        "case_nz2dn_sc_quant_2",
        "case_nz2dn_sc_quant_3",
        "case_nz2dn_sc_quant_4",
    ]
    ...
    case_params_list = [
        ...
        TMovParams(np.float16, np.float16, np.float32, 6, 7, 8, 0, 0, 0, "ND", 512, False, False, True),
        TMovParams(np.float16, np.float16, np.float32, 6, 7, 8),
        ...
        TMovParams(
            np.float32, np.float32, np.float16, 73, 16, 110, 80, 16, 112, "NZ", 512, True, False, True, np.uint64
        ),
