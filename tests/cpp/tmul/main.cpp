...
template <typename T, int dstTileH, int dstTileW, int src0TileH, int src0TileW, int src1TileH, int src1TileW, int vRows,
          ...
          bool sameTile = (dstTileH == src0TileH && dstTileH == src1TileH && dstTileW == src0TileW &&
                           dstTileW == src1TileW)>
bool RunTMulCase(const std::string &dataDir)
{
...
#define TMul_CASE(name, ...) {name, RunTMulCase<__VA_ARGS__>}

static const std::vector<CaseSpec> kSmokeCases = {
    TMul_CASE("case_float_16x32_16x64_16x32_16x32", float, 16, 32, 16, 64, 16, 32, 16, 32),
    TMul_CASE("case_int32_16x32_16x64_16x32_16x32", int32_t, 16, 32, 16, 64, 16, 32, 16, 32),
};

#ifdef PTOISA_FULL_TEST
static const std::vector<CaseSpec> kFullCases = {
    TMul_CASE("case_float_64x64_64x64_64x64_64x64", float, 64, 64, 64, 64, 64, 64, 64, 64),
    TMul_CASE("case_int32_64x64_64x64_64x64_64x64", int32_t, 64, 64, 64, 64, 64, 64, 64, 64),
    TMul_CASE("case_int16_64x64_64x64_64x64_64x64", int16_t, 64, 64, 64, 64, 64, 64, 64, 64),
    TMul_CASE("case_half_16x256_16x256_16x256_16x256", aclFloat16, 16, 256, 16, 256, 16, 256, 16, 256, true),
    TMul_CASE("case_half_16x64_16x128_16x128_16x64", aclFloat16, 16, 64, 16, 128, 16, 128, 16, 64, true),
    TMul_CASE("case_int16_32x128_32x128_32x256_32x128", int16_t, 32, 128, 32, 128, 32, 256, 32, 128),
    TMul_CASE("case_half_16x64_16x128_16x128_16x63", aclFloat16, 16, 64, 16, 128, 16, 128, 16, 63, true),
    TMul_CASE("case_float_16x32_16x64_16x32_16x31", float, 16, 32, 16, 64, 16, 32, 16, 31),
    TMul_CASE("case_int16_32x128_32x128_32x256_32x127", int16_t, 32, 128, 32, 128, 32, 256, 32, 127),
    TMul_CASE("case_int32_16x32_16x64_16x32_16x31", int32_t, 16, 32, 16, 64, 16, 32, 16, 31),
};
#endif
