"""Small-shape sparse flash attention smoke (generated wrapper)."""
...
def sparse_attention_fwd(
    ...
    seq_len = 64  # T.symbolic("seq_len")

    seq_len_kv = 256  # T.symbolic("seq_len_kv")
...
B, S, SKV, H, HKV, DQK, DV, topk = 1, 64, 256, 16, 1, 576, 512, 64
dtype = torch.float16
